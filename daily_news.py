...
- IMPORTANT: Respond with raw markdown only. DO NOT wrap your response in ```markdown``` code blocks or any code fences.
"""
...
def send_email(briefing, to_email):
    ...
    # Convert markdown to real HTML
    html_body = md.markdown(briefing, extensions=['extra', 'nl2br'])

    html = f"""
    <div style="font-family: -apple-system, Arial, sans-serif; max-width: 650px; 
                margin: 0 auto; padding: 30px; line-height: 1.7; color: #333;">
        <h1 style="color: #1a5276; border-bottom: 3px solid #1a5276; 
                   padding-bottom: 12px; font-size: 24px;">
